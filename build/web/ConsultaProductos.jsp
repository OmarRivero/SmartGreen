<%-- 
    ...
    Created on : 28/11/2016, 01:06:27 AM
    Author     : omari
--%>
...
<html lang="es">
    ...
    <body >
        ...
        <section id="cuenta" class="container-fluid" >
            <div>
                <h2 class="section-heading text-center">Productos de SmartGreen</h2>
            </div>
            <br>
            <br>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: white; text-shadow: black 0.1em 0.1em 0.2em;"><%= resultado.getString("precio")%></td>
                            <td style="color: white; text-shadow: black 0.1em 0.1em 0.2em;"><%= resultado.getString("cantidad")%></td>
                            <td style="color: white; text-shadow: black 0.1em 0.1em 0.2em;"><%= resultado.getString("descripcion")%></td>
                        </tr>
                        <% }%>
                    </tbody>
                </table>               
