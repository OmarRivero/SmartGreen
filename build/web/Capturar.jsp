<%-- 
    Document   : Capturar
    Created on : 28/11/2016, 02:15:16 AM
    Author     : omari
--%>
    ...
    <body id="page-top" class="index">
        ...
        <section id="register">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form  name="formModificarProducto" id="formRegistro" action="/SmartGreen/AgregarProducto" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Nombre del Producto"  name="nombreProducto"> 
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Cantidad en existencia"  name="cantidad">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Ruta de imagen Ej: pino.jpg" name="imagen">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="text-center">
                                    <button type="submit" value="submit" class="btn btn-xl">Agregar</button>
                                </div>
                            </div>
                        </form>
                    </div>
